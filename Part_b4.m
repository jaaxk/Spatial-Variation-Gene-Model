...
Xrna(numdsteps,1) = 1;
Xprot(numdsteps,1) = 1;
Yrna(numdsteps/2,1) = 1;
Yprot(numdsteps/2, 1) = 1;
...
title(sprintf('First pos. in space. Total time = %ds', totaltime))
xlabel('Time (s)')
...
title(sprintf('Middle pos. in space. Total time = %ds', totaltime))
xlabel('Time (s)')
ylabel('Concentration (mM)')
hold off
...
title(sprintf('Last pos. in space. Total time = %ds', totaltime))
xlabel('Time (s)')
ylabel('Concentration (mM)')
hold off
...
title(sprintf('First position in time. Total time = %ds', totaltime))
xlabel('Distance (um)')
ylabel('Concentration (mM)')
hold off
...
title(sprintf('Middle position in time. Total time = %ds', totaltime))
xlabel('Distance (um)')
ylabel('Concentration (mM)')
hold off
...
title(sprintf('Last position in time. Total time = %ds', totaltime))
xlabel('Distance (um)')
ylabel('Concentration (mM)')
hold off
